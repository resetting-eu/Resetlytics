...
const navLinks = [
    { name: 'Service Quality', link: '/general/quality', submenu: 0 }, 
    { name: 'Sentiment Analysis', link: '/general/sentiment', submenu: 0 },
    ...
    { name: 'About us', link: '/information/about', submenu: 0 },
]
...
function ResponsiveAppBar() {
    ...
    //const { data: user } = useRetrieveUserQuery(); if we want more information aka company
    ...
    //const { UIoptions } = useContext(appContext);
