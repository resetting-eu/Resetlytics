...
export default function Post({ surveys }: { surveys: ISurvey[] }) {
    ...
    function handleSubscode(event: any): void {
        setSubscode('https://resetlytics.eu/r/1?XHGD97AB03');
    }
            ...
            {surveydetail && (
                ...
                <Button
                    ...
                    {subscode && (<>
                        ...
                        <Typography>You may share it with your clients and/or collaborators so they can answer the survey.</Typography>
                    </>)}
